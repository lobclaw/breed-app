<template>
  <BreedingRecordForm v-if="ready" :mode="recordId ? 'edit' : 'create'" type="follicle_check" :record-id="recordId" :query="routeQuery" />
</template>
...
const recordId = ref('')
usePageSync({ routePath: 'pages/record/breeding-follicle' })
