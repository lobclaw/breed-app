<template>
  <BreedingRecordForm v-if="ready" :mode="recordId ? 'edit' : 'create'" type="abnormal_termination" :record-id="recordId" :query="routeQuery" />
</template>
...
const recordId = ref('')
usePageSync({ routePath: 'pages/record/breeding-termination' })
