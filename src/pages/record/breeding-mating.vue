<template>
  <BreedingRecordForm v-if="ready" :mode="recordId ? 'edit' : 'create'" type="mating" :record-id="recordId" :query="routeQuery" />
</template>
...
const recordId = ref('')
usePageSync({ routePath: 'pages/record/breeding-mating' })
