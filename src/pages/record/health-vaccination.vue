<template>
  <HealthRecordForm v-if="ready" :mode="recordId ? 'edit' : 'create'" type="vaccination" :record-id="recordId" :query="routeQuery" />
</template>
...
const recordId = ref('')
usePageSync({ routePath: 'pages/record/health-vaccination' })
